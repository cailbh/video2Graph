...
interface TreemapChartGenericInstance<ChainableInstance> {
...
type TreemapChartInstance = TreemapChartGenericInstance<TreemapChartInstance>;

declare function TreemapChart(configOptions?: ConfigOptions): TreemapChartInstance;

export default TreemapChart;
export { ConfigOptions, DataNode, Node, TreemapChartGenericInstance, TreemapChartInstance };
