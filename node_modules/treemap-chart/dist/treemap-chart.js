...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Treemap = factory());
  ...
  var LABELS_HEIGHT_OPACITY_SCALE = linear().domain([6, 18]).clamp(true); // available height in px
  ...
  var treemap = index$1({
    ...
    update: function update(state) {
      ...
      var transition$1 = transition().duration(animate ? state.transitionDuration : 0); // Exiting
